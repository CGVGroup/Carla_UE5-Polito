...
class CarlaDataProvider(object):  # pylint: disable=too-many-public-methods
    ...
    @staticmethod
    def set_current_scenario_name(name):
        global _current_scenario_name
        _current_scenario_name = name
    ...
    def create_blueprint(model, rolename='scenario', color=None, actor_category="car", attribute_filter=None):
        ...
        _actor_blueprint_categories = {
            ...
            'trailer': 'vehicle.carlamotors.carlacola',
            'semitrailer': 'vehicle.carlamotors.carlacola',
            'bus': 'vehicle.volkswagen.t2',
            'motorbike': 'vehicle.kawasaki.ninja',
            'bicycle': 'vehicle.diamondback.century',
            'train': 'vehicle.audi.etron',
            'tram': 'vehicle.volkswagen.t2',
        ...
        # Set the model
        try:
            print("Creating actor with model: {}".format(model))
