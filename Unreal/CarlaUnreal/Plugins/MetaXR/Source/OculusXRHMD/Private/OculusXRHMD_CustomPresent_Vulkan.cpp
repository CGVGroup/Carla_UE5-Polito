...
#else
		if (GRHISupportsRHIThread && GIsThreadedRendering)
		{
			IConsoleVariable* CVarRHIThreadEnable = IConsoleManager::Get().FindConsoleVariable(TEXT("r.RHIThread.Enable"));
			if (CVarRHIThreadEnable != nullptr)
			{
