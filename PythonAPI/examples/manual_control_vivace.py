...
class KeyboardControl(object):
    ...
    def __init__(self, world, start_in_autopilot):
        ...
        if isinstance(world.player, carla.Vehicle):
            ...
            actor_in_scene_list = world.world.get_actors()#.filter('Dashboard.*')[0]  # or however your blueprint is named
            print(len(actor_in_scene_list))
            #dashboard.set_control_value_dashboard(123, 456) 
        else:
